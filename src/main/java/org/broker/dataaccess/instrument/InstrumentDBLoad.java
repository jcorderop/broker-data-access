...
import static org.broker.dataaccess.instrument.InstrumentTypeDBLoad.INST_FX_SPOT;
...
public class InstrumentDBLoad implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        InstrumentTypeEntity instTypeSpot = instrumentTypeService.getInstrumentType(INST_FX_SPOT);
